...
addForkletFooter = ->
  ...
  watermark.innerHTML = "<a href='http://www.forklet.com'><img src='http://5c4cf848f6454dc02ec8-c49fe7e7355d384845270f4a7a0a7aa1.r53.cf2.rackcdn.com/93ff51aa-a231-48b9-aabb-4ac8a6c35950/forklet-watermark.png' title='Forklet' width='150' height='23'/></a>"
  watermark.setAttribute("style", "position: fixed; font-size: 10px; z-index: 2147483646; right: 10px; bottom: 5px; font-family: sans-serif")
